...
import { User, Building2, BookOpen, BarChart3, Search, Loader2, AlertCircle, FileJson, MapPin } from 'lucide-react';
    ...
    return (
        <div className="max-w-6xl mx-auto p-4 sm:p-6">
            <div className="text-center mb-8">
                <h1 className="text-4xl font-bold text-black mb-2">Sinta Profile Scraper</h1>
                <p className="text-black">Enter a Sinta ID to scrape and view academic profile information</p>
            </div>
            ...
            {error && (
                <div className="alert-brutal-error mb-8 animate-fade-in">
            ...
            {isLoading && <SintaProfileSkeleton />}
